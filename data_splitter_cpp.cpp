...
int main() {
    ...
    const std::string training_data_file = "/home/nicolas/Desktop/mlpack/data/c_files/training_data.csv";
    const std::string labels_training_file = "/home/nicolas/Desktop/mlpack/data/c_files/labels_training_data.csv";
    const std::string testing_data_file = "/home/nicolas/Desktop/mlpack/data/c_files/testing_data.csv";
    const std::string labels_testing_file = "/home/nicolas/Desktop/mlpack/data/c_files/labels_testing_data.csv";
